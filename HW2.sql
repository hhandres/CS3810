...
CREATE TABLE Borders (maincountry VARCHAR(20), bordercountry VARCHAR(20));
INSERT INTO Borders (maincountry, bordercountry)
VALUES 
('Germany', 'Austria'),
('Germany', 'Belgium'),
...
SELECT bordercountry FROM borders WHERE maincountry='Germany';

SELECT name FROM countries WHERE population > 35000000;

SELECT countries.name, borders.bordercountry FROM countries, borders WHERE (population > 35000000) AND (maincountry = 'Germany');
